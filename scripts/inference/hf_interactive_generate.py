...
class Conversation:
    ...
    def turn(self, user_inp: str) -> None:
        # self.history.append([user_inp, '']) # commmented to make this only repetitive generation instead of chat
        self.history = [[user_inp, '']]
        ...
        # new_tokens = output_ids[0, len(input_ids[0]):] # commmented to make this only repetitive generation instead of chat
